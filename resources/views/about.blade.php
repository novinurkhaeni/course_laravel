                ...
                <div class="bg-gray-100 p-8 md:p-12 lg:px-16 lg:py-24">
                    <div class="mx-auto max-w-xl text-center">
                        ...
                        <div class="mt-4 md:mt-8">
                            <a href="#"
                                class="inline-block rounded-sm border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white transition-colors hover:bg-transparent hover:text-blue-600">
                                Get Started Today
                            </a>
                        </div>
                    </div>
