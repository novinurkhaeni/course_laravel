    ...
    <header class="bg-white">
            ...
            <div class="flex flex-1 items-center justify-end md:justify-between">
                ...
                <nav aria-label="Global" class="hidden md:block">
                    <ul class="flex items-center gap-6 text-xl">
                        ...
                        <li>
                            <x-nav-link class="text-gray-500 transition hover:text-gray-500/75" href="/kursus"
                                :active="request()->is('kursus')">
                                Daftar Kursus
                            </x-nav-link>
                        </li>
                    </ul>
        ...
        <nav id="mobile-menu" aria-label="Mobile Navigation" class="hidden border-t border-gray-200 md:hidden">
            ...
            <ul class="flex flex-col gap-1 px-4 py-4 text-xl">
                <li>
                    <x-nav-link class="block rounded-md px-4 py-2 text-gray-600 hover:bg-gray-100" href="/">
                        Home
                    </x-nav-link>
                </li>
                ...
                <li>
                    <x-nav-link class="block rounded-md px-4 py-2 text-gray-600 hover:bg-gray-100" href="/kursus">
                        Daftar Kursus
                    </x-nav-link>
                </li>
